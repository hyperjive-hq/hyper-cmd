...
from hyper_core.cli import main, discover_commands
...
class TestLaunchUI:
    ...
    def test_launch_ui_import_error(self):
        ...
        with patch('hyper_core.ui.framework.NCursesFramework', side_effect=ImportError("No ncurses")):
    ...
    def test_launch_ui_success(self):
        ...
        with patch('hyper_core.ui.framework.NCursesFramework', return_value=mock_framework):
            with patch('hyper_core.ui.framework.LayoutConfig') as mock_config:
                with patch('hyper_core.ui.framework.MenuItem') as mock_item:
