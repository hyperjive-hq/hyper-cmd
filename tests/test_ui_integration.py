...
import pytest
from hyper_core.ui.renderer import MockBackend, TextStyle, BoxChars
from hyper_core.ui.engine import RenderEngine, RenderContext, UIComponent
from hyper_core.ui.components import Text, Header, StatusBar, MenuBar, ApplicationFrame
