...
class TestMCPCommandExecutor:
    ...
    def test_successful_execution(self):
        ...
        result = self.executor.execute_command("test", MockSafeCommand, {"arg1": "hello", "flag": True})
    ...
    def test_argument_preparation(self):
        ...
        result = self.executor.execute_command("test", MockSafeCommand, {
            "arg1": "test_value",
            "flag": True,
    ...
    def test_error_handling(self):
        ...
        assert any("Error executing command" in content["text"] for content in result["content"])
