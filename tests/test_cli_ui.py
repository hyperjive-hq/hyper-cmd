...
from hyper_core.ui.renderer import MockBackend, TextStyle
from hyper_core.ui.engine import RenderEngine, RenderContext
...
class TestCLIUIIntegration:
    ...
    def test_ui_launch_function(self):
        ...
        with patch('hyper_core.ui.framework.NCursesFramework', side_effect=ImportError("test error")):
