...
from .renderer import RenderingBackend, Window, WindowSpec
...
class UIComponent(ABC):
    ...
    def render(self, ctx: RenderContext) -> None:
        ...
        if current_size != self._last_size or current_pos != self._last_position:
            self.invalidate()
...
class RenderEngine:
    ...
    def needs_redraw(self) -> bool:
        ...
        if self.root_component and self.root_component.get_render_state() in (
            RenderState.DIRTY,
