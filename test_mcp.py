...
def test_interactive_filtering():
    ...
    try:
        ...
        all_commands = set(registry.list_commands())
        filtered_tools = server.get_tools()
        filtered_commands = set(tool['name'][6:] for tool in filtered_tools)
...
def test_mcp_init_command():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            print(f"✓ .mcp.json created with correct configuration")
